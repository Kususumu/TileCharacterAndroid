...
public class DrawBackground {
    ...
    //1390 * 898 * 1.202
    public static float widthOfImage = 1390*1.20267f;
    public static float heightOfImage = 898 * 1.20267f;
    ...
    private static float[] vertexDataLandScape = {
            widthOfImage,0.0f, -1900,0.0f,1.0f,//0,0
            0.0f,heightOfImage,-1900f,1.0f,0.0f,//1,1
            widthOfImage,heightOfImage,-1900f,0.0f,0.0f,//0,1
            widthOfImage,0.0f,-1900f,0.0f,1.0f,//0,0
            0.0f,heightOfImage,-1900f,1.0f,0.0f,//1,1
            0.0f,0.0f,-1900f,1.0f,1.0f//1,0
    };
